<?php
// $Header: /cvsroot/html2ps/box.generic.formatted.php,v 1.16 2006/11/16 03:32:56 Konstantin Exp $
...
class GenericFormattedBox extends GenericBox {
  ...
  function _get_containing_block() {
    ...
    case POSITION_FIXED:
      return $this->_get_containing_block_fixed();
  ...
  function _get_containing_block_absolute() {
    ...
    while ((!is_null($parent->parent)) && 
           ($parent->getCSSProperty(CSS_POSITION) === POSITION_STATIC)) { $parent =& $parent->parent; }
