<?php
// $Header: /cvsroot/html2ps/box.frame.php,v 1.22 2006/11/26 07:10:09 Konstantin Exp $
...
class FrameBox extends GenericContainerBox {
  ...
  function reflow_absolute(&$context) {
    ...
    $this->_positionAbsoluteVertically($containing_block);
    $this->_positionAbsoluteHorizontally($containing_block);
