...
@media only screen and (max-width: <?php echo (isset($_GET['switch_menu_to_mobile']) && intval($_GET['switch_menu_to_mobile']) > 0 ? intval($_GET['switch_menu_to_mobile']) : '767'); ?>px){
.logo {
width: 205px;
margin: 0 auto;
float: none;
