...
class Location
{
     ...
     * @var string
     *
     * @ORM\Column(name="zip", type="string", length=4, nullable=true)
     */
    private $zip = '';
     ...
     * @var string
     *
     * @ORM\Column(name="nl", type="string", length=100, nullable=true)
     */
    private $nl = '';
     ...
     * @var string
     *
     * @ORM\Column(name="innercity", type="string", length=10, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="fixed", type="string", length=5, nullable=true)
     */
    private $fixed;
